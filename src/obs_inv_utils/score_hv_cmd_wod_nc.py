...
def post_harvest_results(cmd_id, harvest_response, wod_file):
    ...
    for item in harvest_response:
        new_item = ObsMetaWodData(
            ...
            convert_to_float(item.min_file_depth),
            convert_to_float(item.max_file_depth),  
            item.sensor,
    ...
    if len(harvest_response) > 1:
        ...
        new_agg_item = ObsMetaWodAggData(
            ...
            convert_to_float(harvest_response[0].min_file_depth),
            convert_to_float(harvest_response[0].max_file_depth),
