...
parser.add_argument("-cat", dest="category", help="Category of variables to inventory. Valid options: atmosphere", choices=['atmosphere', 'ocean', 'ice', 'ozone', 'all', 'list'], default="atmosphere", type=str)
