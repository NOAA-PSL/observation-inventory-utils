...
#run inventory 
python3 auto_inventory.py -cat list -n_jobs 40 -work_dir $WORK_DIR --list airs_airsev airs_aqua amsua_1bamua amsua_nasa_aqua amsua_nasa_r21c amsub_1bamub amv_satwnd atms_atms
    avhrr_avcsam avhrr_avcspm cris_cris cris_crisf4 geo_geoimr
