...
HV_WOD_META = 'hv_wod_meta'

@dataclass
class ObsMetaWodConfig(ConfigInterface):
    """
    ...
    def parse(self):        
        ...
        self.wod_files = self.yaml_loader.get_value(
            key='wod_files',
            document=self.config_data,
            return_type=list
        )
    ...
    def get_wod_file_list(self):
        return self.wod_files
