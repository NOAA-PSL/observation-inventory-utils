...
HV_IODA_META = 'hv_ioda_meta'

@dataclass
class ObsMetaIodaConfig(ConfigInterface):
    """
    ...
    def parse(self):
        ...
        self.ioda_files = self.yaml_loader.get_value(
            key='ioda_files',
            document=self.config_data,
            return_type=list
        )
    ...
    def get_ioda_file_list(self):
        return self.ioda_files
