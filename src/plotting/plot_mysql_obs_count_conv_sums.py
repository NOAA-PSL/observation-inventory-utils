...
plt.tight_layout()
file_name = f"conv_time_series_combo_sum_{args.window}_days.png"
if args.dev:
    file_name = f"conv_time_series_combo_sum_{args.window}_days_" + datetime.now().strftime("%Y%m%d%H%M%S") + ".png"
