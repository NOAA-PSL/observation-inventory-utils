...
db_frame = utils.get_ioda_nc() #TODO THIS PART HERE TO START WITH, may want to base this on the subset amv plots instead 
...
plt.title("Inventory of NNJA Ice files")
