...
#--inventory file size
python3 ${rdir}/src/obs_inv_utils/obs_inv_cli.py get-obs-inventory -c obs_inv_config_nasa_r21c.yaml

python3 ${rdir}/src/obs_inv_utils/obs_inv_cli.py get-obs-count-meta-sinv -c obs_meta_sinv_nasa_r21c.yaml
